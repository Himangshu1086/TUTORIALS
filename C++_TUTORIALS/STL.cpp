//  *****   If we use "bits/stdc++.h", we include every library inside it.
...
// a array donot dynamically allocate memory but memeory does.
...
//-----------------------------------------
	...
	v.push_back({1, 2});                                      // both puch_back AND  emplace_back do the same work.
	v.emplace_back(1, 2);
