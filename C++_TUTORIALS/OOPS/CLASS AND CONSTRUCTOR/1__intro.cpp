...
Object  =  any entity that has state and behavior is known
as an object. it can be physical amd logical
...
shape or rectangle etc.In C++, we use Function overloading 
and Function overriding to achieve polymorphism.
...
known as encapsulation. For example: capsule, it is wrapped with different medicines.
