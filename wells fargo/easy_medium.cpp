/*
Based on rearranging of string: A string s was given which had duplicate 
characters and an integer K was given. We needed to rearrange the characters 
in such a way, that every same character is at least a K distance apart.
